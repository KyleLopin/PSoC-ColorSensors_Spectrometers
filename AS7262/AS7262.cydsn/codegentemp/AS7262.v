// ======================================================================
// AS7262.v generated from TopDesign.cysch
// 03/25/2018 at 07:11
...
module CharLCD_v2_20_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("7a2c666b-bc70-4ab0-bd01-1cb0c55bdbd6/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module USBFS_v3_10_2 (
	...
	cy_psoc3_pins_v1_10
		#(.id("32c48b25-95c4-4977-b3fc-25ddcca918a5/8b77a6c4-10a0-4390-971c-672353e2a49c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("32c48b25-95c4-4977-b3fc-25ddcca918a5/618a72fc-5ddd-4df5-958f-a3d55102db42"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module top ;
	...
	wire [0:0] tmpOE__AS7262_INT_net;
	wire [0:0] tmpIO_0__AS7262_INT_net;
	electrical [0:0] tmpSIOVREF__AS7262_INT_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		AS7262_INT
		 (.oe(tmpOE__AS7262_INT_net),
		  .y({1'b0}),
		  .fb({Net_29}),
		  .io({tmpIO_0__AS7262_INT_net[0:0]}),
		  .siovref(tmpSIOVREF__AS7262_INT_net),
		  .interrupt({Net_15}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__AS7262_INT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("d904235b-1e59-4bf5-94a6-643e26fefca7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
